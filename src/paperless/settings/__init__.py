...
HCAPTCHA_ENABLED: Final[bool] = get_bool_from_env("PAPERLESS_HCAPTCHA_ENABLED")
HCAPTCHA_SITE_KEY: Final[str] = os.getenv("PAPERLESS_HCAPTCHA_SITE_KEY", "")
HCAPTCHA_SECRET_KEY: Final[str] = os.getenv("PAPERLESS_HCAPTCHA_SECRET_KEY", "")
HCAPTCHA_TIMEOUT: Final[float] = get_float_from_env(
    "PAPERLESS_HCAPTCHA_TIMEOUT",
    5.0,
)

if HCAPTCHA_ENABLED and (not HCAPTCHA_SITE_KEY or not HCAPTCHA_SECRET_KEY):
    raise ImproperlyConfigured(
        "PAPERLESS_HCAPTCHA_SITE_KEY and PAPERLESS_HCAPTCHA_SECRET_KEY are required "
